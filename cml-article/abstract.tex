...
Unlike other approaches, such as MDA, the built-in tooling support (and the textual
nature of this programming language and extensible templates) facilitates the
integration to the workflow of software developers, which is expected to promote its adoption.
\keywords{conceptual modeling, UML, OCL, MDA, programming language, compiler,
code generation, model-driven software development, modeling investment, classes,
associations, constraints, specification, software tools}
\end{abstract}
