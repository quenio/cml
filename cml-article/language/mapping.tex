...
that have bought more than 1000 in the \emph{BookStore}. (As with path expressions, the semantics of all expressions will be shown in section \ref{subsec:expr}.)
